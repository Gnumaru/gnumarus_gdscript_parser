...
func _t_ir(h) -> void:
	...
	var bound_iface := Ana.new()
	h.check(bound_iface._check_bound({"kind": "name", "name": "int"}, i), "bound fits")
	h.check(not bound_iface._check_bound({"kind": "name", "name": "String"}, i), "bound rejects")
	h.check(bound_iface._check_bound({}, i), "empty bound passes")
	h.check(bound_iface._check_bound({"kind": "name", "name": "Object"}, {"kind": "name", "name": "Node"}), "bound admits subclass")
	h.check(bound_iface._check_bound({"kind": "union", "arms": [{"kind": "name", "name": "Object"}, {"kind": "name", "name": "int"}]}, {"kind": "name", "name": "Node"}), "union bound admits subclass arm")
	h.check(not bound_iface._check_bound({"kind": "union", "arms": [{"kind": "name", "name": "Object"}, {"kind": "name", "name": "int"}]}, {"kind": "name", "name": "String"}), "union bound rejects outsider")
